restartMozilla: function() {
    ...
    if (toolbar_button_interfaces.PrefBranch.getBoolPref(
    		"extension.tbutton.restart") != true) {
        ...
        toolbar_button_interfaces.PrefBranch.setBoolPref(
        		"extension.tbutton.restart", check.value);
        if (result == false) {
            return
        }
    }    
