...
const EYEDROPPER_URL = "chrome://{{chrome_name}}/content/files/eyedropper.xul";
const CROSSHAIRS_URL = "chrome://{{chrome_name}}/content/files/eyedropper_crosshairs.css";
const NOCURSOR_URL = "chrome://{{chrome_name}}/content/files/eyedropper_nocursor.css";

const ZOOM_PREF = "{{pref_root}}devtools.eyedropper.zoom";
const FORMAT_PREF = "{{pref_root}}devtools.defaultColorUnit";
...
function Eyedropper(chromeWindow, opts = { copyOnSelect: true, context: "other" }) {
  ...
  mm.loadFrameScript("chrome://{{chrome_name}}/content/files/eyedropper-child.js", true);
